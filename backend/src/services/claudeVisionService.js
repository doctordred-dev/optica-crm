...
Сигнали (у порядку пріоритету):
1. Пряма вказівка кількості в тексті — напр. "замовника 2 шт", "замовника 3 шт", "2 пари" → саме стільки пар.
2. Множники в цінах: "Ціна лінзи" з "×2" → 2 лінзи = 1 пара, "×4" → 4 лінзи = 2 пари. "Робота" аналогічно. "Ціна оправи" як сума двох окремих чисел (напр. "2200+690") → 2 оправи → 2 пари.
...
Це реальні бренди з історії замовлень саме цього салону — коли почерк неоднозначний, звір з цим списком (частий випадок: заплутана кирилиця/латиниця, схожі літери). Але якщо на бланку чітко написано інший бренд, якого немає в списку — довіряй бланку, не підганяй під список.
