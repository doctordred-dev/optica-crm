...
const prescriptionSchema = Joi.object({
  rightEye: eyeSchema,
  leftEye: eyeSchema,
  // Свободный текст (обычно число или диапазон через тире, напр. "66-68") —
  // формат намеренно не валидируется жёстко, чтобы не блокировать сохранение.
  pd: Joi.string().trim().max(20).allow(null, ''),
